/**
 * @(#)HttpDoAsClient.java V1.2.0 16-6-1 
...
//            }
    ...
    private String generateTicket() throws GSSException {
        ...
        //final GSSName clientName = manager.createName("hawk",
        //        krb5PrincipalOid);
        final GSSName clientName = manager.createName("hue/hd201.bigdata",
                krb5PrincipalOid);
        ...
        final GSSName serverName = manager.createName("hthrift", krb5PrincipalOid);
        ...
        System.out.println("Ticket is: " + outputBuffer);
        ...
        LoginContext context = new LoginContext("", new Subject(), null,
                new Configuration() {
                    ...
                    public AppConfigurationEntry[] getAppConfigurationEntry(String name) {
                        ...
                        //options.put("keyTab", "/home/cc/IdeaProjects/ambari/hbase-thrift-test/src/cc/test/hawk.keytab");
                        options.put("keyTab", "/home/cc/IdeaProjects/ambari/hbase-thrift-test/src/cc/test/hue.keytab");
                        ...
                        //options.put("principal", "hawk@BIGDATA.COM");
                        options.put("principal", "hue/hd201.bigdata@BIGDATA.COM");
